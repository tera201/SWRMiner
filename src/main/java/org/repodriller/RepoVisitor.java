...
public class RepoVisitor {
	...
	private final Collection<CVPM> visitors;
	...
	void beginRepoVisit(SCMRepository repo, Path workPath, int nThreads, boolean visitorsChangeRepoState) {
		...
		clonePool = new ArrayBlockingQueue<>(nThreads, fair);
	...
	void closeAllPersistence() {
		/* TODO: This API doesn't make sense to me.
		    Why are the persistence mechanisms closed by this class?
